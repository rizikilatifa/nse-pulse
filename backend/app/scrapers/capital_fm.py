...
class CapitalFMScraper(BaseScraper):
    """Scraper for Capital FM Kenya Business (capitalfm.co.ke)."""

    SOURCE_NAME = "Capital FM"
    RSS_URL = "https://capitalfm.co.ke/business/feed/"
    BASE_URL = "https://capitalfm.co.ke"

    async def scrape(self) -> List[dict]:
        """Scrape articles from Capital FM Business RSS feed."""
        articles = []
        ...
        try:
            ...
            print(f"Capital FM scraper error: {e}")
